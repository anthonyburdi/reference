...
@get_and_post_app.get("/items/{item_id}")
...
@get_and_post_app.get("/int_items/{item_id}")
...
@get_and_post_app.get("/enum/{enum}")
...
@get_and_post_app.get("/filepath/{file_path:path}")
...
@get_and_post_app.get("/query_params/")
...
@get_and_post_app.post("/items/{item_id}")
